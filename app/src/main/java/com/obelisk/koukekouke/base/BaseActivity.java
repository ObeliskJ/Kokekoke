...
import com.obelisk.koukekouke.utils.SystemBarTintManager;
...
//        actionBar.hide();
    ...
    public boolean isLogin(){
        BmobUser mUser = BmobUser.getCurrentUser(User.class);
    ...
    protected void onDestroy() {
        super.onDestroy();
      //  BaseActivity.fixFocusedViewLeak(getApplication());
    }
